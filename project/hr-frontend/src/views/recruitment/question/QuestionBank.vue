<template>
  <div class="question-bank">
    <el-card>
      <div class="toolbar">
        <el-button type="primary" @click="handleAdd">创建试题</el-button>
      </div>
...
const handleEdit = (row: Question) => { isEdit.value = true; editId.value = row.id; Object.assign(form, row); dialogVisible.value = true }
